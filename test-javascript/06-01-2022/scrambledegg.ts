function scrambleNumber(str: string, opt: string) {
  let splitted: Array<string> = splitNumber(str); // [0852, 0212, 096'undefined']
  let reversed: string = reverseNumber(splitted);
  let changed: string = changeNumber(reversed, opt);
...
function splitNumber(str: string): Array<string> {
  let idx = 0;
...
function reverseNumber(input: Array<string>): string { // [0852, 0212, 0962] -> [ 0962, 0212, 0852]
  let reversedArr: Array<string> = []; // [0962, 0212, 0852]
...
function changeNumber(str: string, opt: string): string {
  let result = '';
